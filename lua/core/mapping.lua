...
local core_map = {
	...
	["n|<leader>w"] = map_cr("w"):with_desc("edit: quit"),
	...
	["n|;"] = map_cmd(":"):with_noremap():with_desc("edit: not need to press shift to enter command mode"),
	...
	["n|<Left>"] = map_cmd("<Cmd>wincmd h<CR>"):with_silent():with_noremap():with_desc("window: Focus left"),
	["n|<Right>"] = map_cmd("<Cmd>wincmd l<CR>"):with_silent():with_noremap():with_desc("window: Focus right"),
	["n|<Down>"] = map_cmd("<Cmd>wincmd j<CR>"):with_silent():with_noremap():with_desc("window: Focus down"),
	["n|<Up>"] = map_cmd("<Cmd>wincmd k<CR>"):with_silent():with_noremap():with_desc("window: Focus up"),
	...
	["n|H"] = map_cmd("^"):with_noremap():with_silent():with_desc("edit: go to start of line"),
	["n|L"] = map_cmd("g_"):with_noremap():with_silent():with_desc("edit: go to end of line"),
	["x|H"] = map_cmd("^"):with_noremap():with_silent():with_desc("edit: go to start of line"),
	["x|L"] = map_cmd("g_"):with_noremap():with_silent():with_desc("edit: go to end of line"),
	["n|<leader>t"] = map_cr("NvimTreeOpen"):with_noremap():with_silent():with_desc("edit: open NvimTreeOpen"),
	["n|<leader>tt"] = map_cr("NvimTreeClose"):with_noremap():with_silent():with_desc("edit: close NvimTreeOpen"),
	-- Insert mode
