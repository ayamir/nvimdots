...
function mapping.lsp(buf)
	local map = {
		...
		["n|<F3>"] = map_cr("SymbolsOutline"):with_buffer(buf):with_desc("lsp: Toggle outline"),
		...
		["n|gh"] = map_cr("Lspsaga finder def+ref+imp"):with_buffer(buf):with_desc("lsp: Show reference"),
