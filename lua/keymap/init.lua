...
local plug_map = {
    ...
    -- Bufferline
    ["n|gb"] = map_cr("BufferPick"):with_noremap():with_silent(),
    ["n|<A-j>"] = map_cr("BufferNext"):with_noremap():with_silent(),
    ["n|<A-k>"] = map_cr("BufferPrevious"):with_noremap():with_silent(),
    ["n|<A-S-j>"] = map_cr("BufferMoveNext"):with_noremap():with_silent(),
    ["n|<A-S-k>"] = map_cr("BufferMovePrevious"):with_noremap():with_silent(),
    ["n|<leader>bp"] = map_cr("BufferPin"):with_noremap(),
    ["n|<leader>bb"] = map_cr("BufferOrderByBufferNumber"):with_noremap(),
    ["n|<leader>bl"] = map_cr("BufferOrderByLanguage"):with_noremap(),
    ["n|<leader>bd"] = map_cr("BufferOrderByDictionary"):with_noremap(),
