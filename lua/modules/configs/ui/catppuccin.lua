		...
		highlight_overrides = {
			mocha = function(cp)
				return {
					...
					-- Tabs
					TabLineSel = { bg = cp.teal, fg = cp.teal, sp = cp.teal },
					WinBarNC = { bg = cp.teal, fg = cp.teal, sp = cp.teal },
					BufferLineIndicatorSelected = { sp = cp.teal },
					BufferLineSeparatorSelected = { bg = cp.teal },
