...
function config.crates()
	...
	local opts = {
		...
		text = {
			loading = " " .. icons.diagnostics.Perf .. "Loading",
		...
		popup = {
			...
			text = {
				...
				downloads = "%s",
				homepage_label = icons.ui.Compass .. "homepage       ",
				homepage = "%s",
				...
				crates_io = "%s",
				categories_label = icons.ui.Class .. "categories     ",
				keywords_label = icons.diagnostics.Keyword .. "keywords       ",
				version = "  %s",
				prerelease = icons.ui.Fire .. "%s",
				yanked = icons.diagnostics.Error .. "%s",
				version_date = "  %s",
				feature = "  %s",
				enabled = icons.diagnostics.Play .. "%s",
				transitive = icons.ui.List .. "%s",
				normal_dependencies_title = icons.diagnostics.Interface .. "Dependencies",
				build_dependencies_title = icons.ui.Gavel .. "Build dependencies",
		...
		src = {
			insert_closing_quote = true,
			text = {
				prerelease = " " .. icons.ui.Fire .. "pre-release ",
				yanked = " " .. icons.ui.Error_alt .. "yanked ",
			},
			coq = {
				enabled = false,
				name = "Crates",
